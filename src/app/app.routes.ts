...
export const routes: Routes = [
...

  {
    path: 'movements',
    loadComponent: () =>
      import('./pages/movements/movements.page').then((m) => m.MovementsPage),
  },
...

  {
    ...
    loadComponent: () =>
      import('./pages/prescriptions/prescriptions.page').then(
...

  {
    ...
    loadComponent: () =>
      import('./pages/productions/productions.page').then(
        (m) => m.ProductionsPage,
      ),
  },
...

  {
    ...
    loadComponent: () =>
      import('./pages/quality-control/quality-control.page').then(
...

  {
    path: 'laboratories',
    loadComponent: () =>
      import('./pages/laboratories/laboratories.page').then(
        (m) => m.LaboratoriesPage,
      ),
  },
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./pages/production-materials/production-materials.page').then(
        (m) => m.ProductionMaterialsPage,
      ),
  },
